...
export default function SectorPage() {
  ...
  const createMutation = useMutation({
    mutationFn: () => api.post(`/gyms/${selectedGymId}/sectors`, form),
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => api.delete(`/gyms/${selectedGymId}/sectors/${id}`),
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={() => { setForm({ name: '', description: '' }); setModal(true) }} disabled={!selectedGymId}
